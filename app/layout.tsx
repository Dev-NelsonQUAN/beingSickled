...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Being Sickled | Being Sickled Health Foundation',
  ...
  keywords: [
    ...
    'Being Sickled Health Foundation',
  ],
  ...
  openGraph: {
    title: 'Being Sickled | Being Sickled Health Foundation',
    description:
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    alternateName: ['Being Sickled', 'Being Sickled Foundation'],
    url: siteUrl,
