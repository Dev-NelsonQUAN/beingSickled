...
export function LearnSection() {
  ...
  const TELEGRAM_CHANNEL_URL = "https://t.me/your_telegram_channel";
      ...
      <div className="max-w-350 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[6%] items-center relative z-20">
          ...
          {!isPlaying ? (
            ...
            >
              ...
              <button
                ...
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-17 h-17 sm:w-20 sm:h-20 border-2 border-white rounded-full bg-black/40 text-white grid place-items-center group-hover:scale-110 group-hover:bg-pink transition-all shadow-lg"
              >
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2.5 bg-pink hover:bg-[#e00036] text-white font-bold md:px-6 lg:px-10 py-4 lg:py-4.5 rounded-md text-base sm:text-[17px] transition-colors shadow-sm"
          >
